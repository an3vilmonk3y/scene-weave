...
A cinematic visual novel reader that transforms fiction into an illustrated experience — powered by Pollinations FLUX for scene imagery and (optionally) Claude for smarter atmospheric prompts.

## Features

- Paste any story text or URL and read it as a visual novel
...
Just visit the app, paste a story text or URL, and hit **Begin Reading**. No account or API key required to get started.
